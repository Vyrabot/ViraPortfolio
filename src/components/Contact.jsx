...
function Contact() {
  ...
  return (
    <section className="dark:bg-Primery bg-white min-h-[100vh] md:flex md:justify-between md:items-center main-container w-full relative z-1 pb-10 py-20 md:pt-32 lg:pt-32 xl:py-32 sm:overflow-hidden lg:overflow-hidden">
